(module
 ...
 (import "nop" "printNumber" (func $filtercode/assemblyscript/nop/printNumber (param f64)))
 ...
 (export "filterCode" (func $filtercode/assemblyscript/nop/filterCode))
 ...
 (start $~start)
 (func $filtercode/assemblyscript/nop/filterCode
  f64.const 7
  call $filtercode/assemblyscript/nop/printNumber
 )
 ...
 ;; custom section "as-bind_bindings", size 174, contents: "{\"typeIds\":{},\"importedFunctions\":{\"nop\":{\"printNumber\":{\"returnType\":\"void\",\"parameters\":[\"f64\"]}}},\"exportedFunctions\":{\"filterCode\":{\"returnType\":\"void\",\"parameters\":[]}}}"
)
