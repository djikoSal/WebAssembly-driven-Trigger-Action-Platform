(module
 ...
 (import "freeTimeSkip" "currentHour" (func $filtercode/assemblyscript/freeTimeSkip/currentHour (result f64)))
 (import "freeTimeSkip" "currentDay" (func $filtercode/assemblyscript/freeTimeSkip/currentDay (result f64)))
 (import "freeTimeSkip" "skipAction" (func $filtercode/assemblyscript/freeTimeSkip/skipAction))
 (import "freeTimeSkip" "consoleLog" (func $filtercode/assemblyscript/freeTimeSkip/consoleLog (param i32)))
 ...
 (export "filterCode" (func $filtercode/assemblyscript/freeTimeSkip/filterCode))
 ...
 (func $filtercode/assemblyscript/freeTimeSkip/filterCode
  (local $0 f64)
  (local $1 f64)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  ...
  i32.const 0
  i32.store
  call $filtercode/assemblyscript/freeTimeSkip/currentHour
  local.set $0
  ...
  i32.and
  if
   call $filtercode/assemblyscript/freeTimeSkip/skipAction
  else
   local.get $1
   f64.const 6
   f64.eq
   ...
   if
    ...
    i32.store
    i32.const 1056
    call $filtercode/assemblyscript/freeTimeSkip/consoleLog
   end
  end
  global.get $~lib/memory/__stack_pointer
  i32.const 4
