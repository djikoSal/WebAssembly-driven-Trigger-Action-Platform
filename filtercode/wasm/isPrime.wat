(module
 ...
 (import "isPrime" "printNumber" (func $filtercode/assemblyscript/isPrime/printNumber (param f64)))
 ...
 (export "filterCode" (func $filtercode/assemblyscript/isPrime/filterCode))
 ...
 (start $~start)
 (func $filtercode/assemblyscript/isPrime/filterCode
  (local $0 f64)
  (local $1 f64)
  f64.const 2
  local.set $0
  loop $while-continue|0
   ...
   if
    block $while-break|0
     ...
     if
      local.get $0
      call $filtercode/assemblyscript/isPrime/printNumber
      local.get $1
      f64.floor
      call $filtercode/assemblyscript/isPrime/printNumber
      br $while-break|0
 ...
 ;; custom section "as-bind_bindings", size 178, contents: "{\"typeIds\":{},\"importedFunctions\":{\"isPrime\":{\"printNumber\":{\"returnType\":\"void\",\"parameters\":[\"f64\"]}}},\"exportedFunctions\":{\"filterCode\":{\"returnType\":\"void\",\"parameters\":[]}}}"
)
