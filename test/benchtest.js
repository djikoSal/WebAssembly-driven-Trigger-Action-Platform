...
const filterCodeIds = ['access-nsieve', '3d-morph', 'bitops-bits-in-byte', 'controlflow-recursive', 'math-partial-sums'];
const runtimes = ['js-eval', 'js-vm', 'js-ivm', 'wasm', 'js-vm2', 'js-function'];
const requestCounts = [200]//[1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 11000, 12000, 13000, 14000, 15000, 16000, 17000, 18000, 19000, 20000];
let loadParams = [];
filterCodeIds
